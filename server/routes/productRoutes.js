...
const { getProducts, getProductById, deleteProduct, createProduct, updateProduct, createProductReview, getTopRatedProducts } = require('../controllers/productController')
